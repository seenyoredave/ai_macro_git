...
RELEASE_FILES = (
    ...
    "analytics/dashboard_context.py",
    "analytics/canonical_store.py",
    "analytics/canonical_history_bootstrap.py",
    "analytics/comparison_state.py",
    "analytics/change_engine.py",
    ...
    "helpers/bootstrap_canonical_history.py",
    ...
    "data/adoption_national_history.csv",
    "data/adoption_sector_snapshot.csv",
    "data/adoption_consumer_history.csv",
    "data/adoption_ai_supplement_2026.csv",
    "data/commercialization/commercialization_ledger.csv",
    "data/commercialization/source_manifest.csv",
