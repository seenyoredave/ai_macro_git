...
RELEASE_FILES = (
    ...
    ".github/workflows/ai_macro_automation.yml",
    ".githooks/pre-commit",
    ".githooks/pre-push",
    ...
    "helpers/water_campus_registry_contract_test.py",
    "helpers/water_map_viewport_contract_test.py",
    "helpers/water_presentation_smoke_test.py",
    "water/schema.py",
    "water/sources.py",
    "water/refresh.py",
    ...
    "helpers/language_layer_contract_test.py",
    "helpers/language_overlay_boundary_smoke_test.py",
    "helpers/macro_transmission_smoke_test.py",
    "helpers/editorial_quality_contract_test.py",
    "helpers/data_center_identity_authority_test.py",
    "helpers/data_center_registry_smoke_test.py",
    "helpers/data_center_map_contract_test.py",
    "helpers/data_center_registry_release_gate.py",
    "helpers/integrity_linked_state_smoke_test.py",
    "helpers/water_loader_retained_cache_test.py",
