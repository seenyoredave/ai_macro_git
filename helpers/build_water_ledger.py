    ...
    rows = [
        {
            ...
            "source_url": "https://www.usgs.gov/data/estimated-use-water-united-states-county-level-data-2015",
            ...
            "notes": "Reference DOI and USGS metadata are authoritative. The retained workbook was acquired from a public mirror because the source host was unavailable in the build environment; checksum is retained.",
        },
        {
            ...
            "source_url": "https://www.eia.gov/electricity/data/water/",
...
def _field_dictionary() -> pd.DataFrame:
    rows = [
        ("observation_id", "Reference", "Stable unique observation key", "text", "platform-generated"),
        ("flow_type", "Reference", "Withdrawal, consumptive use, delivery, discharge, or other typed flow", "controlled vocabulary", "never collapsed into a generic total"),
        ("original_value", "Reference", "Value exactly as represented by the retained source record", "source-native", "preserved before conversion"),
        ("original_unit", "Reference", "Unit attached to the original value", "source-native", "preserved before conversion"),
        ("average_mgd", "Reference", "Average million gallons per day", "Mgal/d", "derived only when period and volume permit"),
        ("source_category", "Reference", "Groundwater, surface water, reclaimed, mixed, or other source", "controlled vocabulary", "source medium, not legal entitlement"),
        ("water_quality_class", "Reference", "Fresh, brackish, saline, reclaimed, mixed, or other", "controlled vocabulary", "kept separate from source medium"),
        ("measurement_basis", "Reference", "Metered, reported estimate, agency model, inferred residual, or other basis", "controlled vocabulary", "determines evidentiary treatment"),
