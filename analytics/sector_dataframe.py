...
def resolve_sector_dataframe(raw_data):
    ...
    for _, row in yf_df.iterrows():
        ...
        rows.append({
            ...
            "YTD Return": resolve_field("YTD Return", source_data),
            "YTD Start Market Cap": resolve_field("YTD Start Market Cap", source_data),
            "YTD Year": resolve_field("YTD Year", source_data),
